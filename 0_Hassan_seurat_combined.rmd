---
title: "scRNA-seq data analysis of dissected fly brain, Hassan project"
author: "Tingting"
date: "11/12/2021"
output:
...
```{r}
pwd="/Volumes/BIOINFORMATICS/projects/hassan2021/src/"
indir="/Volumes/bioinformatics/projects/hassan2021/output/02_cellranger_count/outs/"
outdir="/Volumes/BIOINFORMATICS/projects/hassan2021/output/06_seurat_combined/"
...
# Create Seurat object directly from cellranger count output

Read in 10X data from Cellranger output
```{r message=FALSE, warning = FALSE}
data <- Read10X(data.dir = paste0(indir, "filtered_feature_bc_matrix"))
df <- CreateSeuratObject(counts = data, project = "control1", min.cells = 3)
```
