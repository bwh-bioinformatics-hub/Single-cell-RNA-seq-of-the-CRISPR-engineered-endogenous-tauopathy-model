...
#treatments <- c("P251L", "control", "TauKO", "P251L", "control", "TauKO")
...
# If Vanitha
```{r }
outdir="/Volumes/BIOINFORMATICS/projects/hassan2022/output/04_seurat_multi/vanitha/"
projectName="vanitha2022"
samples = c("CRN00224921", "CRN00224922", "CRN00224923", "CRN00224924", "CRN00224925", "CRN00224926")
treatments <- c("mutant", "control", "control", "mutant", "control", "mutant")
```
...
# developer
pdf(paste0(outdir, "combined.dotplot.DEtop3.clustered.geneSymbol.developer.pdf"), width = 10, height = 15)
...
pdf(paste0(outdir, "combined.dotplot.DEtop3.clustered.geneID.developer.pdf"), width = 10, height = 15)
...
# developer
pdf(paste0(outdir, "combined.dotplot.clustered.geneSymbol.developer.pdf"), width = 10, height = 15)
...
pdf(paste0(outdir, "combined.dotplot.clustered.geneID.developer.pdf"), width = 10, height = 15)
...
scrna.combined <- RenameIdents(scrna.combined, `0` = "Dopaminergic", `1` = "Cholinergic", `2` = "T4_T5", `3` = "Dopaminergic", `4` = "T4_T5", `5` = "TMY14", `6` = "C2_C3", `7` = "Unknown", `8` = "L1_L2_L3_L4_L5", `9` = "Kenyon", `10` = "C2_C3", `11` = "Kenyon", `12` = "L1_L2_L3_L4_L5", `13` = "Unknown", `14` = "L1_L2_L3_L4_L5", `15` = "L1_L2_L3_L4_L5", `16` = "L1_L2_L3_L4_L5", `17` = "C2_C3", `18` = "Kenyon", `19` = "Tm1_TmY8", `20` = "Mi1", `21` = "Tm1_TmY8", `22` = "TMY14", `23` = "Lawf2", `24` = "Glutamatergic", `25` = "Cholinergic", `26` = "Glutamatergic", `27` = "Perineurial", `28` = "L1_L2_L3_L4_L5", `29` = "Poxn")
```
...
```{r }
Idents(scrna.combined) <- factor(Idents(scrna.combined), levels = c("Dopaminergic",  "Cholinergic", "T4_T5", "Dopaminergic", "T4_T5", "TMY14",  "C2_C3", "Unknown", "L1_L2_L3_L4_L5", "Kenyon", "C2_C3",  "Kenyon", "L1_L2_L3_L4_L5", "Unknown", "L1_L2_L3_L4_L5",  "L1_L2_L3_L4_L5", "L1_L2_L3_L4_L5", "C2_C3", "Kenyon", "Tm1_TmY8", "Mi1", "Tm1_TmY8", "TMY14", "Lawf2", "Glutamatergic", "Cholinergic", "Glutamatergic", "Perineurial", "L1_L2_L3_L4_L5", "Poxn"))

pdf(paste0(outdir, "combined.dotplot.afterAnnotation.clustered.geneSymbol.developer.pdf"), width = 10, height = 15)
p1 <- Clustered_DotPlot_relabel(scrna.combined, features = markers.ID, plot_km_elbow = F, new_row_labels = geneTable$geneSymbol[match(markers.ID, geneTable$geneID)])
print(p1)
dev.off()

pdf(paste0(outdir, "combined.dotplot.afterAnnotation.clustered.geneID.developer.pdf"), width = 10, height = 15)
...
pdf(paste0(outdir, "DE.treatment.volcano.pdf"))
for (cell in list_cell){
  mutant.responseA <- FindMarkers(scrna.combined, ident.1 = paste0(cell, "_mutant"), ident.2 = paste0(cell, "_control"), verbose = FALSE)
  p1 <- EnhancedVolcano(mutant.responseA, lab = rownames(mutant.responseA), x = 'avg_log2FC', y = 'p_val')
  print(p1)
  write.table(mutant.responseA, paste0(outdir, cell, ".mutant.DE.treatment.xls"), sep = "\t", col.names = NA)
} 
dev.off()

# add cell number col
# title mutant vs. control
# add cell type col, cat DE in one table
```
