...
output_dir <- "/Users/hassanbukhari/Desktop/OneDrive - Mass General Brigham/Tau P251LKI figures updated-02-27-223/New Seurat Object-2023/FlyPhone DB/All Pathways-Rerun/Controls/Output/"
...
#exprMat <- read.csv(file = "/Users/hassanbukhari/Desktop/Tau P251L Knock In Paper/Raw data/Code/Controls/Controls-Expression matrix.csv", row.names = 1, check.names = FALSE)
